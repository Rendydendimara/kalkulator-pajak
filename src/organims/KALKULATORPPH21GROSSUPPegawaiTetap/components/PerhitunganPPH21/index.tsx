            ...
            <Box mt="20px">
                <VStack spacing="40px" justifyContent="flex-start" alignItems="flex-start" w="full">
                    ...
                    <Box w="full" border="1px solid black" padding="2">
                        ...
                        <VStack spacing="20px" justifyContent="flex-start" alignItems="flex-start" w="full">
                            <VStack padding="2" border="1px solid black" spacing="15px" justifyContent="flex-start" w="full">
                                <FormControllCustom>
