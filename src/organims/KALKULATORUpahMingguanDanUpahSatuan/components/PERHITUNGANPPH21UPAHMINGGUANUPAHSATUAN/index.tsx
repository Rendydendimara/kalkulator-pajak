...
export default function PERHITUNGANPPH21UPAHMINGGUANUPAHSATUAN() {
            ...
            <Box mt="20px">
                <VStack spacing="40px" justifyContent="flex-start" alignItems="flex-start" w="full">
                    <Box w="full" border="1px solid black" padding="2">
                        <Heading as="h2" size="md" mb="8px">PERHITUNGAN PPH21 UPAH MINGGUAN & UPAH SATUAN</Heading>
                        <VStack spacing="15px" justifyContent="flex-start" w="full">
                            <FormControllCustom isRequired>
                                <LabelItem fontWeight="800" label="Upah Mingguan" />
                                <InputCustom
                                    isTesting
                                    borderColor="black"
                                />
                            ...
                            <FormControllCustom isRequired>
                                <LabelItem label="Hari Kerja dalam seminggu" />
                                <InputCustom
                                    isTesting
                                    type="number"
                                    borderColor="black"
